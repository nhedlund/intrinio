...
def screener(conditions, order_column, order_direction, primary_only):

    """
    Args:
        conditions: comma-separated list of conditions.
            Each condition consists three (or four) elements separated by tildes (~): Data_tag~Operator~Value~Label(Optional)
        ...
        primary_only: Return only primary securities (excluding special securities such as preferred shares)
        
    Returns:
        List of Tickers that meet criteria
    """
    df = get('securities/search',
